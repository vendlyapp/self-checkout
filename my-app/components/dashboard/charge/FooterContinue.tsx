...
const FooterContinue: React.FC<FooterContinueProps> = ({
  ...
  <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 z-10">
    <div className="mb-2">
      ...
      {promoApplied && (
        <div className="flex items-center justify-between mt-1">
          <div className="text-green-700 font-semibold text-[15px]">10% Rabatt auf Bio-Produkte</div>
    ...
    <div className="flex items-center justify-between pt-2">
      ...
      <div className="text-green-600 font-bold text-[26px]">CHF {total.toFixed(2)}</div>
    </div>
    <button
      className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold rounded-full py-3 text-[18px] flex items-center justify-center gap-2 mt-4 transition-colors"

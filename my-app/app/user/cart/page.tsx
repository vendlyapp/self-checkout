      ...
      <div className="flex-1 px-4 pt-4 pb-32 mt-[70px]">
        {cartItems.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full mt-16">
            ...
            <p className="text-gray-500 mb-4">Fügen Sie Produkte hinzu um zu beginnen</p>
            <button className="bg-[#25D076] text-white px-4 py-2 font-semibold rounded-full mt-4 w-65 h-12 flex items-center justify-center gap-2" onClick={() => router.push('/user')}>Produkte anzeigen <ChevronRight className="w-5 h-5 text-white font-semibold" /></button>
          </div>
          ...
          <div className="space-y-4">
            ...
            {/* Promo code */}
            <div className="text-[#25D076] text-sm font-semibold mt-2 cursor-pointer">Promo Code?</div>
          </div>
        )}
      </div>
    </div>

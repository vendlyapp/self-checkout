  ...
  return (
    <div className="flex items-center gap-3 bg-transparent md:bg-card rounded-2xl border border-border p-4 lg:p-5 md:shadow-sm">
      ...
      <div className="flex-1 min-w-0">
        <div className="text-[11px] lg:text-xs text-muted-foreground uppercase tracking-wide">Kontaktieren</div>
        <div className="font-semibold text-foreground leading-snug text-sm mt-0.5">Schreiben Sie uns</div>
        <div className="text-[11px] lg:text-xs text-muted-foreground mt-0.5 break-all">hilfe@self-checkout.ch</div>
      </div>
      <button

import { 
  Package, Tag, ShoppingCart, Users, Clock, Star, Heart, Leaf, Carrot, Circle, Flower, CircleDot, Apple, Percent
} from 'lucide-react'
...
export const getIcon = (iconName: string): React.ReactNode => {
  // Si el icono viene de la base de datos, intentar usarlo directamente
  // Si no existe en el mapa, usar Package como fallback

...
export const mockProducts: Product[] = [
  ...
  },
  {
    id: 'prod-008',
    name: 'Schokobrötchen',
    description: 'Süsse Schokobrötchen mit Schokoladenstückchen',
    price: 1.50,
    category: 'Gebäck',
    categoryId: 'pastries',
    stock: 35,
    ...
    sku: 'SCHOKOBROETCHEN',
    tags: ['brötchen', 'schokolade', 'süss', 'schokoladenstückchen'],
    rating: 4.3,
    reviews: 67,
    weight: 80,
  ...
  },
  {
    id: 'prod-019',
    name: 'Mohnbrötchen',
    description: 'Süsse Mohnbrötchen mit Mohnfüllung und Zuckerglasur',
    price: 1.80,
    category: 'Gebäck',
    categoryId: 'pastries',
    stock: 25,
    ...
    sku: 'MOHNBRÖTCHEN',
    tags: ['brötchen', 'mohn', 'süss', 'zuckerglasur'],
    rating: 4.2,
    reviews: 45,
    weight: 90,
    dimensions: { length: 12, width: 8, height: 4 },

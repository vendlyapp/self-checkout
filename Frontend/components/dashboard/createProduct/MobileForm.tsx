      ...
      <div className="relative bg-white rounded-3xl shadow-2xl max-w-sm w-full mx-4 animate-in fade-in-0 zoom-in-95 duration-300" style={{ pointerEvents: 'auto' }}>
            ...
            <div className="p-6">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-[#25D076] to-[#20BA68] text-white py-4 px-6 rounded-2xl font-semibold hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98] transition-ios text-base flex items-center justify-center gap-2 cursor-pointer"
                ...
                {variants.map((variant, index) => (
                  ...
                  >
                    <div className="space-y-1">
                      <label className="block text-[14px] text-black font-semibold">
                      ...
                      <div className="flex items-center space-x-2 justify-between w-full">
                        <input
                          ...
                          required
                          className={`flex-1 p-2 w-full h-[46px] border rounded-sm text-sm bg-white ${
...
function ProductAdditionalInfoMobile({ product }: { product: { 
  ...
  return (
    <div className="space-y-5 mt-5">
        ...
        <div className="bg-white rounded-2xl p-5 border border-gray-200">
          ...
          <div className="flex flex-col items-center bg-gray-50 rounded-xl p-4">
            ...
            <p className="text-xs text-gray-500 mt-3 text-center">
              Scannen Sie diesen Code, um das Produkt anzuzeigen
            </p>
          </div>
        </div>
      )}
        ...
        <div className="bg-white rounded-2xl p-5 border border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Strichcode</h3>
            </div>
            <button
          ...
          <div className="flex flex-col items-center bg-gray-50 rounded-xl p-4">
            ...
            />
            <p className="text-xs text-gray-500 mt-3 text-center">
              Scannen Sie diesen Barcode, um das Produkt zu identifizieren
            </p>
          </div>
        </div>
      )}
      ...
      <div className="bg-white rounded-2xl p-5 border border-gray-200">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Produktinformationen</h3>
        <div className="space-y-3">
          {product.sku && (

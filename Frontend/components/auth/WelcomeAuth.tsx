...
const WelcomeAuth: React.FC = () => {
  ...
  if (checking) {
    return (
      <div className="flex flex-1 min-h-dvh w-full items-center justify-center bg-gradient-to-br from-brand-50 via-background-cream to-brand-100">
  ...
  return (
    <div className="flex flex-1 min-h-dvh w-full items-center justify-center bg-gradient-to-br from-brand-50 via-background-cream to-brand-100 p-4 sm:p-6">

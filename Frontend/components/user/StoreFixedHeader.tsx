    ...
    <>
      ...
      >
        ...
        <div className="flex-shrink-0">
          <button
            onClick={onScanQR}
            className="bg-brand-500 cursor-pointer justify-center text-center text-white px-3 sm:px-3.5 py-2 sm:py-2.5 flex items-center gap-1.5 sm:gap-2 rounded-[30px] w-[90px] sm:w-[110px] h-[48px] sm:h-[50px] hover:bg-brand-600 active:bg-brand-700 active:scale-95 transition-ios-fast touch-target-sm whitespace-nowrap shadow-sm hover:shadow-md"

              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                ...
                {cartItems.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-12 gap-4">
                    ...
                    <button
                      onClick={() => router.push("/charge")}
                      className="bg-brand-500 hover:bg-brand-600 text-white font-semibold rounded-xl px-6 py-3 text-lg transition-colors shadow"
                      aria-label="Zurück zu den Produkten"
                    >
                      Produkte hinzufügen
                    </button>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 sticky top-6">
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  <button
                    ...
                    className="w-full mt-4 bg-brand-500 hover:bg-brand-600 text-white font-semibold rounded-xl px-6 py-3 text-lg transition-colors shadow"
                  ...
                  <button
                    ...
                    className="w-full mt-2 bg-red-500 hover:bg-red-600 text-white font-semibold rounded-xl px-6 py-3 text-lg transition-colors shadow"
                  >
                    Warenkorb leeren
                  </button>
                </div>

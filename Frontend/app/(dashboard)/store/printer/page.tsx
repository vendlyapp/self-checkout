          ...
          <div className="px-4 py-6 pb-32 max-w-full mx-auto">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                Konfigurieren Sie Ihren POS-Drucker
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200 text-center">
              <div className="w-20 h-20 rounded-xl bg-brand-100 flex items-center justify-center mx-auto mb-4">
                <Printer className="w-10 h-10 text-brand-600" />
              </div>
              ...
              <p className="text-xs text-gray-400">
                Hier können Sie in Zukunft Ihren POS-Drucker konfigurieren, Testdrucke durchführen und Druckeinstellungen anpassen.
              </p>
            </div>
          </div>
        </div>

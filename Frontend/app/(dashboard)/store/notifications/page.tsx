          ...
          <div className="px-4 py-6 pb-32 max-w-full mx-auto">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                Verwalten Sie Ihre System-Alerts
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200 text-center">
              ...
              <p className="text-xs text-gray-400">
                Hier können Sie in Zukunft Ihre Benachrichtigungseinstellungen verwalten und System-Alerts konfigurieren.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="bg-white rounded-xl p-12 shadow-sm border border-gray-200 text-center">
              <div className="w-24 h-24 rounded-xl bg-brand-100 flex items-center justify-center mx-auto mb-6">
                <Bell className="w-12 h-12 text-brand-600" />
              </div>

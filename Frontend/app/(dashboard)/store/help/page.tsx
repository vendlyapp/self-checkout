          ...
          <div className="px-4 py-6 pb-32 max-w-full mx-auto">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200 text-center">
              ...
              <p className="text-xs text-gray-400 mb-4">
                Hier finden Sie in Zukunft häufig gestellte Fragen, Tutorials und Support-Informationen.
              </p>
              <div className="mt-6 pt-6 border-t border-gray-200">
                <p className="text-sm font-semibold text-gray-900 mb-2">Kontakt</p>
                <a 
                  href="mailto:hilfe@self-checkout.ch" 
                  className="text-brand-600 hover:text-brand-700 text-sm transition-ios"
                >
                  hilfe@self-checkout.ch
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="bg-white rounded-xl p-12 shadow-sm border border-gray-200 text-center">
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                <p className="text-base font-semibold text-gray-900 mb-3">Kontakt</p>
                <a 
                  href="mailto:hilfe@self-checkout.ch" 
                  className="text-brand-600 hover:text-brand-700 text-base transition-ios"
                >
                  hilfe@self-checkout.ch
                </a>
              </div>

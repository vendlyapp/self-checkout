...
export default function SalesOrderDetailClient({ orderId }: SalesOrderDetailClientProps) {
  ...
  } = useInvoicesByOrderId(orderId);

  const invoicesLoading = isInitialQueryLoading(invoicesFetched, invoicesFetching);

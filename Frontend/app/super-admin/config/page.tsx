...
export default function SuperAdminConfigPage() {
  ...
  useEffect(() => {
    ...
    AVAILABLE_PAYMENT_METHODS.forEach((method) => {
      if (method.code.toLowerCase() !== 'bargeld') {
        // Bargeld kann nicht global deaktiviert werden
  ...
  const handleToggleGlobalDisable = async (code: string) => {
    ...
    // Bargeld kann nicht deaktiviert werden
    if (method.code.toLowerCase() === 'bargeld') {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast.success(
          newState
            ? `Zahlungsmethode "${method.displayName}" wurde eingeschränkt`
            : `Zahlungsmethode "${method.displayName}" wurde freigeschaltet`
        );
      } else {
              ...
              {enabledMethods.length > 0 && (
                <div className="space-y-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className="text-base font-semibold text-foreground">Verfügbar</h3>
                      <p className="text-xs text-muted-foreground">Verfügbar für alle Geschäfte</p>
                    </div>
                        ...
                        >
                          <div className="flex items-center justify-between gap-4">
                            ...
                            <button
                              ...
                              title="Diese Zahlungsmethode für alle Geschäfte einschränken"
                            >
              ...
              {disabledMethods.length > 0 && (
                <div className="space-y-4 pt-6 border-t-2 border-orange-200 dark:border-orange-500/30">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className="text-base font-semibold text-foreground">Eingeschränkt</h3>
                        ...
                        >
                          <div className="flex items-center justify-between gap-4">
                            ...
                            <button
                              ...
                              title="Einschränkung für diese Zahlungsmethode aufheben"
                            >
                              {updating === method.code ? (
                                <LoaderIcon className="w-3.5 h-3.5 animate-spin" />
                              ) : (
